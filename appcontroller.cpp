...
AppController::AppController(QObject *parent)
  ...
  int selectedPlaylistId = getSelectedPlaylist();
  ...
  int currentPlayingSongId =
      getFromLocalStorage("current_playing_song_id", -1).toInt();
...
void AppController::addSongsToPlaylist(int playlistId, const QList<QFileInfo> &audioFiles) {
